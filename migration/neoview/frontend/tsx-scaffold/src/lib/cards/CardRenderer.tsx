/**
 * @migrated-from src/lib/cards/CardRenderer.svelte
 * @source-hash sha256:dd854b58fb1db524426e01c2a983113d3664ec0d55afaeda73ae44717842c069
...
{isVisible ? (<Fragment>
	<CollapsibleCard id={cardId} panelId={panelId} title={cardDef?.title || cardId} icon={cardDef?.icon} height={cardHeight} onHeightChange={handleHeightChange} fullHeight={isFullHeight} hideIcon={hideIcon} hideTitle={hideTitle} hideHeader={hideHeader} compact={compact} orientation={orientation}>
		{isLoading ? (<Fragment>
			...
			<div className="text-destructive py-2 text-xs">卡片加载失败: {cardId}</div>
		</Fragment>)}</Fragment>)}
	</CollapsibleCard>
