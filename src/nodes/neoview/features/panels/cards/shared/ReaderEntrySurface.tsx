  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "banner" && "h-24 w-full rounded border data-[selected=true]:border-primary",
        variant === "thumbnail" && "h-36 w-full rounded border data-[current=true]:border-primary data-[current=true]:ring-1 data-[current=true]:ring-primary",
        className,
      )}
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          variant === "banner" && "grid size-full grid-cols-[5rem_minmax(0,1fr)] overflow-hidden",
      ...
      >
        ...
        <span className={cn(
          ...
          variant === "thumbnail" && "flex items-center gap-1 border-t px-1.5 py-1.5",
        )}>
