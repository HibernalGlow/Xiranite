...
export function Component({ compId, host }: NodeComponentProps<TransqCardState>) {
  ...
  return (
    <TooltipProvider>
      <div ref={surface.ref} className="@container/transq flex h-full min-h-0 w-full overflow-hidden">
...
function CollapsedView(props: ViewProps) {
  ...
  return (
    <div data-testid="transq-collapsed-view" className="flex h-full min-h-0 w-full items-center gap-2 overflow-hidden rounded-xl border bg-background/85 px-3 py-2 shadow-sm">
