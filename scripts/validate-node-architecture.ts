...
async function collectNeoViewLayerFindings(nodeDir: string, findings: Finding[]): Promise<void> {
  ...
  const allowedRootFiles = new Set(["index.ts", "core.ts", "ui-core.ts", "platform.ts", "cli.ts", "Tui.tsx", "help.ts", "interaction.ts"])
  ...
  const allowedExports = new Set([".", "./core", "./ui-core", "./platform", "./testing", "./cli", "./help", "./interaction"])
