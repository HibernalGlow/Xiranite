...
interface CzkawkaConfig extends CliInteractionPreferencesSource { tool?: CzkawkaTool; recursive?: boolean; use_cache?: boolean; save_also_as_json?: boolean; delete_outdated_cache?: boolean; cache_folder_path?: string; config_folder_path?: string; duplicate_minimal_hash_cache_size_kib?: number; duplicate_minimal_prehash_cache_size_kib?: number; hash_type?: "crc32" | "xxh3" | "blake3"; check_method?: "name" | "size" | "size-and-name" | "hash"; similarity?: number; scan_presets?: CzkawkaScanPreset[]; active_scan_preset_id?: string }
...
const SCAN_VALUE_FLAGS = new Set([...CZKAWKA_CLI_VALUE_FLAGS, "--reference", "--exclude-dir", "--exclude-item", "--allow", "--exclude-ext", "--min-size", "--max-size", "--threads", "--filter", "--cache-folder", "--config-folder", "--min-hash-cache-kib", "--min-prehash-cache-kib", "--lang"])
