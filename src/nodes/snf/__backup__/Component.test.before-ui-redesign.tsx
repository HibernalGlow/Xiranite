...
describe("app-owned snf Component", () => {
  test.each(NODE_SURFACE_TEST_MODES)(
    "renders the %s surface with SNF-specific UI",
    (mode) => {
      setSurface(mode)
      render(<Component compId="comp-snf" host={createHost({ pathsText: "D:/archives/a.zip" })} />)
