...
func TestExtractEmbeddedLocalBackendBundlePreservesRelativeRuntimeAssets(t *testing.T) {
	bundle := embeddedLocalBackendRuntimeBundle{
		files: fstest.MapFS{
			"build/xiranite-backend.js":                &fstest.MapFile{Data: []byte(`require("./backend-assets/sharp.node")`)},
			"build/backend-assets/sharp.node":          &fstest.MapFile{Data: []byte("native-sharp")},
			"build/backend-assets/reader-runtime.wasm": &fstest.MapFile{Data: []byte("reader-runtime")},
		},
