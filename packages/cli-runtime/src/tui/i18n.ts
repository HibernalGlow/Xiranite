...
export function resolveTerminalLanguage(value?: string, env: Record<string, string | undefined> = process.env): TerminalLanguage {
  const candidate = value || env.LC_ALL || env.LC_MESSAGES || env.LANG || "en"
