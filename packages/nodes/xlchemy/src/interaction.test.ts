...
describe("xlchemy interaction schema", () => {
  test("maps shared TUI fields to the native core input", () => {
    ...
    expect(input).toMatchObject({ action: "convert", paths: ["D:/images", "D:/more"], format: "AVIF", outputMode: "directory", outputDir: "D:/out", existingPolicy: "rename", animationDetectionFormats: ["webp"] })
