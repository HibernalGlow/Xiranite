...
function resolveNativeTarget(targetPrefix: readonly string[], key: string): string[] {
  ...
  if (section === "reader.view.page_layout" && key === "splitHorizontalPages") return ["reader", "split_wide_pages"]
...
const ENUM_RULES: readonly { pattern: RegExp; values: ReadonlySet<string> }[] = [
  ...
  { pattern: /\.backgroundMode$/, values: new Set(["solid", "auto", "edge", "ambient", "aurora", "spotlight"]) },
  { pattern: /\.lastDynamicBackgroundMode$/, values: new Set(["auto", "edge", "ambient", "aurora", "spotlight"]) },
