...
// `enum` 改为 const 对象，兼容项目的 `erasableSyntaxOnly: true` 配置
// （enum 是 TS-only 语法，不可被擦除）
export const DataTableActions = {
  SET: "SET",
  SET_IS_LOADING: "SET_IS_LOADING",
} as const
// type 联合保留给 switch case 用作字面量类型
type DataTableActionType =
  | typeof DataTableActions.SET
  | typeof DataTableActions.SET_IS_LOADING
