...
export function CzkawkaResultTable(props: CzkawkaResultTableProps) {
  ...
  const rowHeight = Math.max(props.wrapText ? WRAPPED_RESULT_ROW_HEIGHT : RESULT_ROW_HEIGHT, previewSize + 16)
