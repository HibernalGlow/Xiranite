  ...
  return (
    <TooltipProvider>
      <div ref={surface.ref} className="@container/lata relative flex h-full min-h-0 w-full overflow-hidden">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-[radial-gradient(circle_at_12%_0%,hsl(var(--primary)/0.12),transparent_36%),radial-gradient(circle_at_88%_8%,hsl(var(--chart-3)/0.14),transparent_34%)]" />
