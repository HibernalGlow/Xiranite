...
export const PACKAGE_MODULES = [
  ...
  { id: "logx", name: "LogX", version: "0.1.0", category: "dev", description: "Inspect, query, aggregate, and diagnose structured Xiranite logs.", icon: "ScrollText", keywords: ["log", "jsonl", "diagnostics", "errors", "sessions", "telemetry"] },
  ...
  { id: "neoview", name: "NeoView", version: "0.1.0", category: "image", description: "High-performance image and comic reader with shared GUI, CLI, and TUI core.", icon: "BookImage", keywords: ["reader", "comic", "cbz", "archive", "image"], externalLaunch: { instancePolicy: "reuse", requiredHostCapabilities: ["contract", "state", "runner", "clipboard", "downloads", "localFiles", "config", "env"], backendFeatures: ["reader"], intents: [{ id: "open", targetKinds: ["file", "directory"], maxTargets: 1 }] } },
...
export const nodeHelpLoaders = {
  ...
  logx: () => import("@xiranite/node-logx/help") as Promise<{ help: NodeHelp }>,
