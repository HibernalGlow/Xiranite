...
export const PACKAGE_MODULES = [
  ...
  { id: "clipm", name: "ClipM", version: "0.1.0", category: "image", description: "Score personal comic preferences and persist model results in names and metadata.", icon: "ScanSearch", keywords: ["comic", "manga", "preference", "classification", "scoring", "siglip", "archive"] },
...
export const packageModuleLoaders = {
  ...
  clipm: () => import("@/nodes/clipm/entry") as Promise<{ default: AppNodeEntry }>,
...
export const nodeHelpLoaders = {
  ...
  clipm: () => import("@xiranite/node-clipm/help") as Promise<{ help: NodeHelp }>,
