...
const CARD_LOADERS: Record<ReaderCardId, ReaderCardDefinition["load"]> = {
  ...
  "folder-ratings": () => import("./cards/FolderRatingsCard"),
  "favorite-tags": () => import("./cards/FavoriteTagsCard"),
  "emm-sync": () => import("./cards/EmmSyncCard"),
  "emm-config": () => import("./cards/EmmConfigCard"),
  "emm-raw-data": () => import("./cards/EmmRawDataCard"),
...
const CARD_ICONS = {
  ...
  "folder-ratings": Gauge,
  "favorite-tags": Tags,
  "emm-sync": DatabaseBackup,
  "emm-config": DatabaseBackup,
  "emm-raw-data": DatabaseBackup,
