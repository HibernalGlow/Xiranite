...
describe("loadNeoviewSessionOptions", () => {
  ...
  it("[neoview.settings.runtime-gui] [neoview.folder.settings-toml] [neoview.folder.search-settings-toml] applies shared TOML defaults", async () => {
    ...
    try {
      ...
      expect(folderConfig).not.toContain("[nodes.neoview.folder.empty_area]")
      ...
      expect(folderConfig).not.toContain("[nodes.neoview.folder.details]")
      expect(folderConfig).not.toContain("[nodes.neoview.folder.details.column_widths]")
      expect(folderConfig).not.toContain("[nodes.neoview.folder.search]")
      ...
      expect(folderConfig).not.toContain("[nodes.neoview.folder.tree_view]")
