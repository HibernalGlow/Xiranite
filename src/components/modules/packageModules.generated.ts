...
export const PACKAGE_MODULES = [
  ...
  { id: "diny", name: "Diny", version: "0.1.0", category: "dev", description: "AI-powered git commit message generator wrapping the diny binary.", icon: "GitCommitHorizontal", keywords: ["git", "commit", "ai", "diny", "message"] },
...
export const packageModuleLoaders = {
  ...
  diny: () => import("@/nodes/diny/entry") as Promise<{ default: AppNodeEntry }>,
...
export const nodeHelpLoaders = {
  ...
  diny: () => import("@xiranite/node-diny/help") as Promise<{ help: NodeHelp }>,
