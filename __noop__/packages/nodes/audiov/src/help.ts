...
export const help = {
  ...
  translations: {
    "zh-CN": {
      title: "AudioV",
      short: "通过原生 ffmpeg 工作流从视频文件中提取音轨。",
      description: "使用固定 AAC/M4A 配置从每个视频提取第一条音轨。",
      whenToUse: [
        "需要从工作区 UI 或 CLI 使用本节点的视频处理流程时使用 AudioV。"
      ],
      workflows: [
        {
          title: "工作区 UI",
          summary: "从模块库部署 AudioV，并在节点面板上运行。",
          ui: [
            "打开模块库，将 AudioV 部署到当前工作区。",
        ...
        {
          title: "CLI",
          summary: "直接在终端运行 AudioV。",
          cli: [
            "运行 `xiranite audiov` 进入引导模式（当命令支持交互式提示时）。",
            "运行 `xiranite audiov --help` 查看该节点命令的具体参数与子命令。"
          ]
        }
      ],
      commands: [
