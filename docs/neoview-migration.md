...
- 组件审计结果为 `converted=124`、`adapter-needed=22`、`manual=114`、`replaced=282`、`blocked=9`；模块审计结果为 `converted=246`、`adapter-needed=45`、`manual=75`、`replaced=77`、`blocked=4`。这些状态是 React 迁移路由，不代表功能已经完成。
