...
export const READER_CARD_MANIFEST = [
  ...
  card("emm-tags", "EMM 标签", "properties", true, true, 0, false, false),
  card("book-settings", "本书设置", "properties", true, true, 1, true, true),
  card("folder-ratings", "文件夹平均评分", "properties", true, true, 2, true, true),
  card("favorite-tags", "收藏标签快选", "properties", true, true, 3, true, false),
  card("emm-sync", "EMM 同步", "properties", true, true, 4, true, true),
  card("emm-config", "EMM 配置", "properties", true, true, 5, true, false),
  card("emm-raw-data", "EMM 数据库记录", "properties", true, true, 6, true, true),
  card("thumbnail-architecture-metrics", "缩略图架构指标", "properties", true, true, 7, true, false),
