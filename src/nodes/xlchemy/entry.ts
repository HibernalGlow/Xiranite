...
const dataSchema = z.object({
  ...
  format: z.enum(["JPEG XL", "AVIF", "WebP", "PNG", "TIFF", "JPEG", "Lossless JPEG Transcoding", "JPEG Reconstruction", "Smallest Lossless", "dynar"]).optional(),
  lossless: z.boolean().optional(),
  quality: z.number().optional(),
  clipboardFormat: z.enum(["JPEG XL", "AVIF", "WebP", "PNG", "TIFF", "JPEG", "Lossless JPEG Transcoding", "JPEG Reconstruction", "Smallest Lossless"]).optional(),
  clipboardLossless: z.boolean().optional(),
