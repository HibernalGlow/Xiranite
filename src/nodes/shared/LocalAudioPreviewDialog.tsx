...
function LocalAudioPlayer({ item, source, position, canNavigate, onPrevious, onNext }: { item: LocalAudioPreviewItem; source?: string; position: string; canNavigate: boolean; onPrevious: () => void; onNext: () => void }) {
