...
export const help = {
  ...
  "translations": {
    "zh-CN": {
      "title": "Linku",
      "short": "创建、移动、列出并恢复符号链接记录。",
      "description": "创建、移动、列出并恢复符号链接记录。",
      "whenToUse": [
      ...
      "workflows": [
        {
          "title": "工作区 UI",
          "summary": "从模块库部署 Linku，并在节点面板上运行。",
          "ui": [
            "打开模块库，将 Linku 部署到当前工作区。",
        ...
        {
          "title": "CLI",
          "summary": "直接在终端运行 Linku。",
          "cli": [
            "命令支持交互式提示时，运行 `xiranite linku` 进入引导模式。",
            "运行 `xiranite linku --help` 查看该节点命令的完整参数与子命令。"
          ]
        }
      ],
      "commands": [
