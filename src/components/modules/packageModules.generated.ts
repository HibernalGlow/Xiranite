...
export const PACKAGE_MODULES = [
  ...
  { id: "neoview", name: "NeoView", version: "0.1.0", category: "image", description: "High-performance image and comic reader with shared GUI, CLI, and TUI core.", icon: "BookOpen", keywords: ["reader", "comic", "cbz", "archive", "image"] },
...
export const packageModuleLoaders = {
  ...
  melodeck: () => import("@xiranite/node-melodeck") as Promise<{ default: NodeEntry }>,
