  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="flex h-7 w-7 items-center justify-center rounded-sm border border-border bg-background/60 text-muted-foreground hover:border-acid/60 hover:text-foreground transition-colors"
      ...
      <div className="relative">
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex h-7 items-center gap-2 rounded-sm border border-border bg-background/60 px-2.5 font-mono text-[11px] tracking-wider text-foreground hover:border-acid/60 transition-colors"
        >
                ...
                {THEMES.map((t) => (
                  <button
                    ...
                    onClick={() => {
                      setTheme(t.id);
                      setOpen(false);
                      // Defaulting modes based on themes
                      if (t.id === "utopia") document.documentElement.classList.add("dark");
