...
const preloadSnapshotSchema = z.object({
  ...
  scheduledPages: z.number().int().nonnegative().optional(),
  upscaledPages: z.number().int().nonnegative().optional(),
  queuedPageIndexes: z.array(z.number().int().nonnegative()).max(100_000).optional(),
  processingPageIndexes: z.array(z.number().int().nonnegative()).max(100_000).optional(),
  upscaledPageIndexes: z.array(z.number().int().nonnegative()).max(100_000).optional(),
